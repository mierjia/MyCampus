...
exports.getCourseTable = async (req, res) => {
    let userId = req.body.user_id;  // 确保从请求体中正确获取 user_id
    let info = [userId];
    console.log(req.body);

    // Query to get the course table information
    let sql = 'SELECT * FROM coursetable WHERE user_id=?';
...
//添加课程信息
exports.setCourseTable = async (req, res) => {
    let info = {
        user_id: req.body.user_id,
        course_name: req.body.course_name,
        start_week: req.body.startWeek,
        end_week: req.body.endWeek,
        start_period: req.body.startPeriod,
        end_period: req.body.endPeriod,
        day: req.body.day,
    }
    let sql = 'INSERT INTO coursetable SET ?';
    const result = await query(sql, info);
    data = {
        state: 's',
        data: {},
